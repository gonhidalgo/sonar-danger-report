...
public class MarkdownExporter implements IExporter {
    ...
    private static final String pruebatitulo = "Estoesunaprueba";
    ...
    public File export(Object data, String path, String filename) throws IOException, BadExportationDataTypeException {
        ...
        try (
            ...
            final List<String> volumesHeader2 = new ArrayList<>(Arrays.asList(VOLUMES_HEADER));
            final List<List<String>> volumes2 = DataAdapter.getVolumes(report);
            final String volumeTable2 = generateMDTable(volumesHeader, volumes2);
